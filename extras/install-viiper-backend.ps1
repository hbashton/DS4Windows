...
$script:InfrastructureVersion = "VIIPER-0.1.6-rc4.6.4+USBIP-0.9.7.7"
...
try {
    ...
    Write-Step "Step 1 of 4 - Installing VIIPER 0.1.6-rc4.6.4"
    ...
    $bundledViiperSha256 = Read-PackagedSha256 `
        ...
        (Split-Path -Leaf $script:BundledViiperPath)
    Write-SetupLog "Using packaged VIIPER 0.1.6-rc4.6.4 x64 binary." Green
