...
namespace DS4WindowsTests
{
    ...
    public class DualSenseSpeakerVolumeTests
    {
        ...
        [TestMethod]
        public void EveryPhysicalBluetoothDualSenseUsesUnifiedTransport()
        {
            Assert.IsTrue(DualSenseDevice.
                RequiresUnifiedBluetoothOutputTransport(ConnectionType.BT));
            Assert.IsFalse(DualSenseDevice.
                RequiresUnifiedBluetoothOutputTransport(ConnectionType.USB));
        }
