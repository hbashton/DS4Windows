...
REQUIRED_PUBLISH_FILES = {
    ...
    "extras/VIIPER-0.1.6-rc4.6.4-x64.exe",
    "extras/VIIPER-0.1.6-rc4.6.4-x64.exe.sha256",
    "extras/VIIPER-0.1.6-rc4.6.4-LICENSES.txt",
    "extras/VIIPER-0.1.6-rc4.6.4-PROVENANCE.txt",
    "extras/VIIPER-0.1.6-rc4.6.4-BUILD-NOTES.txt",
    "extras/LICENSE.txt",
...
VIIPER_RELEASE = {
    "Version": "v0.1.6-rc4.6.4",
    "Source": "https://github.com/hbashton/VIIPER",
    "Source commit": "85b6d4800d29741103747ea77f654c7e9b8d8b67",
    "Toolchain": "Go 1.27.0 windows/amd64",
    "Build": "GOOS=windows GOARCH=amd64 CGO_ENABLED=0 BUILD_TYPE=Release",
    "Embedded commit": "85b6d48",
    "Embedded build date": "2026-09-22T11:13:43Z",
    "Embedded VCS revision": "85b6d4800d29741103747ea77f654c7e9b8d8b67",
    "Embedded VCS time": "2026-09-22T11:03:30Z",
    "Embedded VCS modified": "false",
    "PE file version": "0.1.6.0",
    "PE product version": "0.1.6-rc4.6.4",
    "Binary": "VIIPER-0.1.6-rc4.6.4-x64.exe",
    "Binary SHA-256": "CBADAD730A7E7A1FB806BF650F321A1B06475D5315BB418378C97D5C774B1AE1",
    "Authenticode status at packaging": "NotSigned",
    "License notice": "VIIPER-0.1.6-rc4.6.4-LICENSES.txt",
    "License notice SHA-256": "51CB2C59E164E9AEF91F8A277B54F4E48F85B3A54CF71A466EE42DD0EBDF9C58",
}
...
VIIPER_NOTICE_HASHES = {
    "VIIPER-0.1.6-rc4.6.4-BUILD-NOTES.txt": "37B83F57119491ACCBFA5803D1E8C87896815910ED37CCE35A34F40CA5892F3D",
...
VIIPER_INFRASTRUCTURE_MARKER = "VIIPER-0.1.6-rc4.6.4+USBIP-0.9.7.7"
...
def main() -> int:
    ...
    for contract in [
        ...
        'StartupTaskWarningCorrelationId',
        '-ReclaimExisting',
        '-IncludeMarked:$ReclaimExisting',
        'Xml = $taskXml',
        'ErrorAction = "Stop"',
    ...
    actual_viiper_hash = sha256(
        args.publish_root / "extras" / "VIIPER-0.1.6-rc4.6.4-x64.exe"
    )
    sidecar_hash = (
        args.publish_root / "extras" / "VIIPER-0.1.6-rc4.6.4-x64.exe.sha256"
    ...
    viiper_provenance = (
        args.publish_root / "extras" / "VIIPER-0.1.6-rc4.6.4-PROVENANCE.txt"
    ).read_text(encoding="utf-8")
    viiper_license_hash = sha256(
        args.publish_root / "extras" / "VIIPER-0.1.6-rc4.6.4-LICENSES.txt"
    )
    ...
    functional_version_contracts = [
        (probe, r'ExpectedViiperVersion\s*=\s*"([^"]+)"', "0.1.6-rc4.6.4", "probe version"),
