...
$script:InfrastructureVersion = "VIIPER-0.1.4-rc4.5.6+USBIP-0.9.7.7"
...
try {
    ...
    Write-Step "Step 1 of 4 - Installing VIIPER 0.1.4-rc4.5.6"
    ...
    $bundledViiperSha256 = Read-PackagedSha256 `
        ...
        (Split-Path -Leaf $script:BundledViiperPath)
    Write-SetupLog "Using packaged VIIPER 0.1.4-rc4.5.6 x64 binary." Green
