                ...
                try
                {
                    ...
                    AppLogger.LogToGui(
                        ...
                        $"writerMaximumCompletionMs={device.BluetoothRealtimeWriterMaximumCompletionMilliseconds:F1} " +
                         ...
                         $"padForgeAccepted={padForgeSpeakerTransport?.AcceptedReports ?? 0} " +
                         $"padForgeSaturated={padForgeSpeakerTransport?.SaturatedReports ?? 0} " +
                         $"padForgeFaults={padForgeSpeakerTransport?.TransportFaults ?? 0} " +
                         $"padForgeCompletionMaxMs={padForgeSpeakerTransport?.MaximumCompletionMilliseconds ?? 0.0:F2} " +
                         $"padForgeSubmissionGapMaxMs={padForgeSpeakerTransport?.MaximumSubmissionGapMilliseconds ?? 0.0:F2} " +
                         $"padForgeWritesAheadMax={padForgeSpeakerTransport?.MaximumNativeWritesAhead ?? 0} " +
                         $"padForgeStateWrites={device.BluetoothPadForgeGameStateWrites} " +
                         $"padForgeStateDuplicates={device.BluetoothPadForgeGameStateDuplicates} " +
                         $"padForgeStateCoalesced={device.BluetoothPadForgeGameStateCoalesced} " +
                         $"padForgePreparedWrites={device.BluetoothPadForgePreparedStateWrites} " +
                         $"padForgePreparedDuplicates={device.BluetoothPadForgePreparedStateDuplicates} " +
