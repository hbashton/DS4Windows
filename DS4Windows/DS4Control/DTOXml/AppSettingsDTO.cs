...
namespace DS4WinWPF.DS4Control.DTOXml
{
    ...
    public class AppSettingsDTO : IDTO<BackingStore>
    {
        ...
        [XmlElement("SwipeProfileList")]
        public string SwipeProfileList { get; set; } = "";
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            SwipeProfileList = string.Join(",", source.swipeProfileList);
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            destination.swipeProfileList = new System.Collections.Generic.List<string>();
            if (!string.IsNullOrEmpty(SwipeProfileList))
            {
                foreach (string prof in SwipeProfileList.Split(','))
                {
                    string trimmed = prof.Trim();
                    if (!string.IsNullOrEmpty(trimmed))
                        destination.swipeProfileList.Add(trimmed);
                }
            }
    ...
    public class SwitchProSupportSettings : BaseInput